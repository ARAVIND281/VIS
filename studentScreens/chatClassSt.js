...
export default class chatClassSt extends Component {
    uid = '';
    messagesRef = null;
    constructor(props) {
        super(props);
        ...
        db.collection("students")
            ...
            .onSnapshot((querySnapshot) => {
                querySnapshot.forEach((doc) => {
                    ...
                    this.loadMessages(doc.data().grade + doc.data().section, (message) => {
    ...
    loadMessages = (where, callback) => {
        this.messagesRef = firebase.database().ref(where + 'chatclassstudent');
        ...
        return (
            <View style={{ flex: 1, backgroundColor: '#ffefff' }}>
                <ImageBackground source={require('../assets/bg.png')} style={styles.image}>
                    <View>
                        <MyHeader title='Talk with Class Student' navigation={this.props.navigation} />
                    </View>
                    <GiftedChat
