...
export default class updateReportasSubject4 extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        db.collection(this.state.student_email_id)
            ...
            .onSnapshot((querySnapshot) => {
                querySnapshot.forEach((doc) => {
                    this.setState({
                        class_report: doc.data().subjectTeacher,
                        updateclass_report: doc.data().subjectTeacher
                    });
                });
            });
    }
